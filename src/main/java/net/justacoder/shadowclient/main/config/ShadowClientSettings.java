...
public class ShadowClientSettings {
    ...
    public static final ColorSetting loadingScreenBackgroundColor = addSetting(new ColorSetting(TranslatableString.of("setting.shadowclient.loading_background_color"), -14997957));
