...
public class NoFireOverlay extends Module {
    ...
    public final NumberSetting OFFSET = new NumberSetting(TranslatableString.of("setting.module.shadowclient.nofireoverlay.offset"), 0.01f, 0.6f, 0.6f, 2, MathUtils.Easing.EASE_IN_QUADRATIC);
