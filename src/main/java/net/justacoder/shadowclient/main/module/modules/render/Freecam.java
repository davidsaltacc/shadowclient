...
public class Freecam extends Module {
    ...
    public NumberSetting SPEED = new NumberSetting(TranslatableString.of("setting.module.shadowclient.freecam.speed"), 0.05f, 8, 1, 2, MathUtils.Easing.EASE_IN_QUADRATIC);
